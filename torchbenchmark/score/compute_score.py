...
class TorchBenchScore:
    def __init__(self, ref_data=None, spec=SPEC_FILE_DEFAULT, target=TARGET_SCORE_DEFAULT, version="v2"):
        active_versions = {"v1": TorchBenchScoreV1, "v2": TorchBenchScoreV2 }
